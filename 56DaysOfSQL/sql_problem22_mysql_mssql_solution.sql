...
(8, 'Peter', 'Parker', 22, 'M', 'Engineer', 'Engineering', 73000, 87000, 11000, 'peter.parker@example.com', 'Queens', '404 Willow St', 1),
(9, 'Clint', 'Barton', 29, 'M', 'Mechnic', 'Engineering', 76000, 87000, 11500, 'clint.barton@example.com', 'San Francisco', '404 Spurce St', 1);
